...
import { Megaphone, ExternalLink, Globe, Filter } from 'lucide-react';
...
export default function LeaderBoard() {
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-700/60 rounded-2xl p-4 backdrop-blur-sm shadow-xl max-h-[400px] flex flex-col">
      <div className="flex flex-col gap-3 mb-3 shrink-0">
        ...
        <div className="flex items-center gap-2 bg-slate-800/80 p-1.5 rounded-lg border border-slate-700/50">
